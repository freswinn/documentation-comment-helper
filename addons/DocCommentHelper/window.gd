...
const SettingsPath = "ref://addons/DocCommentHelper/DocCommentSettings.json"
...
func _check_for_settings_file() -> bool:
	var file_found = DirAccess.open("ref://addons/DocCommentHelper").file_exists("DocCommentSettings.json")
	return file_found
